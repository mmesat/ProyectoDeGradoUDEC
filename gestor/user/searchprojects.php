...
<?php $numerorolbd= $_SESSION['HjkrTS3986Yg444aASdsHjkrTS3986Yg444aASds12'];
?>
			...
			<div id="right">
				...
				<div class="post">
				  <div class="contentarea"><form id="form1" name="form1" method="post" action="chooseproject.php">
                      ...
                      <p>
                        <select name="project" id="project"style="width:550px"><?php
 $link = mysql_connect('localhost', 'root', 'int15BCD');
 mysql_select_db('gestor', $link);
 $query="SELECT id_usuario FROM usuario WHERE id_rol =$numerorolbd";
 $resultado2 = mysql_query($query)or die( "Error en $query: " . mysql_error() );
$renglon2 = mysql_fetch_array($resultado2);

  $resultadoid= $renglon2['id_usuario'];
...
mysql_close($link);
 ...
 $link = mysql_connect('localhost', 'root', 'int15BCD');
 mysql_select_db('gestor', $link);
 $query="SELECT nombre_proyecto, id_proyecto FROM proyecto WHERE id_director !=0 AND id_director=$resultadoid";
