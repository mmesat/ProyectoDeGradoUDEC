...
<body>
	<div id="container">
		...
		<div id="content">
			...
			<div id="right">
				<div class="post">
					<h2>Seleccione tarea que tenga pendiente</h2>
					<div class="comments">
				...
				<div class="post">
				  <div class="contentarea">
				    <p>&nbsp;</p>
				    <p>&nbsp;</p>
				    <form id="form1" name="form1" method="post" action="taskasing.php">
				      <p>&nbsp;</p>

                      <p>
                        <select name="proyecto" id="proyecto"style="width:550px">
                          <?php
 $link = mysql_connect('localhost', 'root', 'int15BCD');
 mysql_select_db('gestor', $link);
 $query="SELECT nombre_tarea, id_tarea FROM tarea WHERE id_usuario = $gen AND estado != 'FINALIZADO'";
 $rs = mysql_query($query)or die( "Error en $query: " . mysql_error() );
if (mysql_num_rows($rs)==0){
$valor2=0;
$valor="NO TIENE NIGUNA TAREA ASIGNADA EN EL MOMENTO";
